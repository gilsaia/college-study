...
class set
{
    ...
    struct BinaryNode
    {
        ...
        BinaryNode(const Comparable &theElement,BinaryNode *lt,BinaryNode *rt,BinaryNode *ft,bool us=1)
        :element{theElement},left{lt},right{rt},father{ft},use{us}{min=findMin(this),max=findMax(this);}
        BinaryNode(Comparable &&theElement,BinaryNode *lt,BinaryNode *rt,BinaryNode *ft,bool us=1)
        :element{std::move(theElement)},left{lt},right{rt},father{ft},use{us}{min=findMin(this),max=findMax(this);}
    };
...
set<Comparable>::BinaryNode * set<Comparable>::findMin(BinaryNode *t) const
{
    ...
    BinaryNode *next=findMin(t->left);
    if(next!=nullptr)
    {
        return next;
    }
...
set<Comparable>::BinaryNode * set<Comparable>::findMax(BinaryNode *t) const
{
    ...
    BinaryNode *next=findMax(t->right);
    if(next!=nullptr)
    {
        return next;
    }
